...
* In a terminal or command window, navigate to the top-level project directory [NikitaPande13\LinearRegression\CarPricePrediction](https://github.com/NikitaPande13/Machine_Learning-All-Model-In-One/edit/main/LinearRegression)(that contains this README) and run one of the following commands:
